...
import (
	...
	"github.com/Nelwhix/duolingo-medlab-go/pkg/middlewares"
...
func main() {
	...
	err = http.ListenAndServe(":8080", gHandlers.CombinedLoggingHandler(os.Stdout, c.Handler(middlewares.ContentTypeMiddleware(r))))
	if err != nil {
